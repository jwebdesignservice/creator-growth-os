...
import { AUTH_ACTIVITY_CHART } from "@/lib/dev-dashboard/mock-data";
import type { AuthActivityChart } from "@/lib/dev-dashboard/types";

const CHART_W = 700;
const CHART_H = 200;

export function AuthActivityTrendsCard({ data }: { data?: AuthActivityChart }) {
  const { series, xLabels, yLabels, yMax } = data ?? AUTH_ACTIVITY_CHART;
  ...
  return (
    <DevSectionCard
      title="Auth Activity Trends"
      trailing={
        <div className="flex flex-wrap items-center gap-2">
          <CardSelect label="Metric" value="Authentication Events" />
